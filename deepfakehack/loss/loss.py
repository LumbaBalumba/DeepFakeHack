...
from deepfakehack.loss.triplet_miner import PositiveTripletMiner
from deepfakehack.loss.duplet_miner import DupletMiner


class DeepFakeloss(nn.Module):
    def __init__(self, gamma=1.0, margin=0.1):
        super().__init__()
